...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        Product p2 = new Product(2, "Pen", 15.0);
        Product p3 = new Product(3, "Backpack", 450.0);
        Product p4 = new Product(4, "Water Bottle", 120.0);
        ...
        Product p11 = new Product(11, "Tpye-C Cable", 180.0);

        // 3. Create Orders using methods

        // Anna's Order with 10 products
        createOrder(anna, 101, createProductList(p1, p2, p3, p4, p5, p6, p7, p8, p9, p10, p11));
